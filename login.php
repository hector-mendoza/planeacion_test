            ...
            <div id="signupbox" style="display:none; margin-top:50px" class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2 col-sm-12">
                <div class="panel panel-info">
                    ...
                    <div class="panel-body" >
                        <form id="signupform" class="form-horizontal" role="form" action="val_reg.php" method="POST">
                            ...
                            <!-- <div class="form-group">
                                <label for="lastname" class="col-md-3 control-label">Apellido Materno</label>
                                <div class="col-md-9">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control" name="grado" placeholder="Grado académico" required>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="formacion" class="col-md-3 control-label">Formación</label>
                                <div class="col-md-9">
                                    <input type="text" class="form-control" name="formacion" placeholder="Formación" required>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <input type="password" class="form-control" name="r_pass" placeholder="Repetir contraseña" required>
                                </div>
                            </div>
