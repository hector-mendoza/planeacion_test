...
?>
    <script>
        alert("Primero debes ingresar el número de clases");
        location.href = "num_clases.php";
    </script>
<?php
}
?>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <form method="POST" id="insert_refBas" accept-charset="utf-8">
                                                <div class="modal-body">
                                                    ...
                                                    <input type="text" placeholder="ISBN" name="isbn" class="form-control" id="isbn"><br>
                                                    <input type="text" placeholder="Autor" name="autor" class="form-control" id="autor"><br>
                                                    Fecha:
                                                    <input type="date" class="form-control" name="fechaRef" id="fechaRef"><br><br>
                                                    <input type="text" placeholder="Titulo" name="titulo" class="form-control" id="titulo"><br>
                                                    <input type="text" placeholder="Editorial" name="editorial" class="form-control" id="editorial"><br>
                                                </div>
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-default" data-dismiss="modal">Cerrar</button>
                                                    <input type="submit" id="submit" class="btn btn-primary" value="DAR  DE ALTA">
                                                </div>
                                            </form>
                                        </div>
                                    </div>
